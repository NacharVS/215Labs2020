...
namespace _215Labs2020.Kuzmin_Aleksey
{
    class Bank2
    {
        ...
        private static void Check_Donation(double donation)
        {
            ...
            {
                if (_take) { Bank2._Bank -= donation; }
                else { Bank2._Bank += donation; }
                Console.WriteLine(Bank2._line);
                Console.WriteLine($"Баланс счета составляет: {Bank2._Bank}");
                Console.WriteLine(Bank2._line);
                Console.WriteLine();
                _take = false;
                _take2 = false;
        ...
        private static void First_deposit()
        {
            ...
            Bank2.Check_Sign(Console.ReadLine());
        ...
        private static void Refill()
        {
            ...
            Bank2.Check_Sign(Console.ReadLine());
            Bank2.Check_Donation(_donation);
        }
        private static void In_year()
        {
            ...
            for (int i = 0; i < a; i++)
            {
                b = Bank2._Bank + Bank2._Bank * _persent * i;
            }
        ...
        {
            Console.WriteLine(Bank2._line);
            Console.WriteLine($"Баланс вашего счета равен: {Bank2._Bank}");
            Console.WriteLine(Bank2._line);
            Console.WriteLine();
        }
