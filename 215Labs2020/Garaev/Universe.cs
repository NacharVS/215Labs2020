...
namespace _215Labs2020.Garaev
{
    class Planets
    {
        ...
        public static async Task MongoDeletePlanets(string searchName)
        {
            string connectionString = "mongodb://localhost";
            var client = new MongoClient(connectionString);
            var database = client.GetDatabase("Gallactic");
    ...
    class Satellites
    {
        ...
        public static async Task MongoDeleteSatellites(string searchName)
        {
            string connectionString = "mongodb://localhost";
            var client = new MongoClient(connectionString);
            var database = client.GetDatabase("Gallactic");
    ...
    class Comets
    {
        ...
        public static async Task MongoDeleteKomets(string searchName)
        {
            string connectionString = "mongodb://localhost";
            var client = new MongoClient(connectionString);
            var database = client.GetDatabase("Gallactic");
