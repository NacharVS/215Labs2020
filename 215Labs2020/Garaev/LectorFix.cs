...
namespace _215Labs2020.Garaev1
{
    class Student
    {
        public StringBuilder Name;
        public StringBuilder Rame;
        public StringBuilder name;
        //{
        //    get
        //    {
        ...
        public static void peremennaya()
        {
            Console.Write("Введите количество студентов: ");
            int col = int.Parse(Console.ReadLine());
            Student[] StudentName = new Student[col];
            ...
            for (int k = 0; k < col; k++)
            {
                ...
                StudentName[k].name = new StringBuilder(Console.ReadLine());
                StudentName[k].Name = StudentName[k].name;
                ...
                Console.WriteLine();
                if (StudentName[k].name[0] != Char.ToUpper(StudentName[k].name[0]))
                {
                    StudentName[k].name[0] = Char.ToUpper(StudentName[k].name[0]);
                }
            }
            int maxx = 0;
            for (int i = 0; i < col; i++)
